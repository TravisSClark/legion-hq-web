...
const inputFolder = "C://Users/wolfs/OneDrive/Pictures/working folder/cards/";
const outputFolder = "C://Users/wolfs/OneDrive/Pictures/working folder/icons/";
  ...
  files.forEach((file) => {
    ...
    Jimp.read(inputFolder + file)
      .then((image) => {
        ...
        // counterpart cards (large side for more definition)
