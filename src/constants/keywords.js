const keywords = {
  ...
  "Advanced Targeting":
    "When a unit with the Advanced Targeting X keyword makes an \
...
Suppression token, if able.",
  "Allies of Convenience":
    "Units with the Allies of Convenience keyword may issue Orders \
...
from the Attack Pool.",
  Arsenal:
    "A unit with the Arsenal X keyword can contribute X weapons to \
...
in the same army.",
  "Ataru Mastery":
    "A unit with the Ataru Mastery keyword can make up to 2 \
...
gains 1 Aim token after the attack is resolved.",
  "Attack Run":
    "At the start of its Activation, a unit with the Attack Run \
keyword may increase or decrease its Speed by 1 until the end \
of that Activation.",
  Barrage:
    "If a unit has the Barrage keyword, it may make 2 Attack actions \
during its Activation instead of 1 if it does not use the Arsenal \
keyword during that Activation.",
  Block:
    "When a unit with the Block keyword is defending, if it spends 1 \
...
up to X allied units within 2 to each gain 1 Surge token.",
  Bounty:
    "During Setup, a unit with the Bounty keyword chooses an \
...
the allied unit's controlling player scores 1 VP.",
  Cache:
    "During Setup, a unit with an equipped Upgrade Card that has \
...
any miniatures added to the unit with that card are defeated.",
  "Calculate Odds":
    "As a Card action, a unit with the Calculate Odds keyword can \
choose an allied Trooper unit within 2 and in LOS to gain 1 \
Aim token, 1 Dodge token, and 1 Suppression token.",
  Charge:
    "After a unit that has the Charge keyword makes a Move action \
...
action against that unit using only Melee weapons.",
  "Climbing Vehicle":
    "A unit with the Climbing Vehicle keyword can make Climb \
...
of the keyword; it does not issue 2 Orders.",
  Counterpart:
    "While building an army, this mini may be added to an X unit. (See Rulebook)",
  Cover:
  ...
  "Creature Trooper":
    "Creature troopers: have notched bases, can reverse, can pivot even while engaged, can attack and withdraw during the same activation, and do not receive cover from barricades.",
  Cunning:
...
for priority.",
  "Danger Sense":
    "When a unit with the Danger Sense X keyword would remove \
...
matching specified unit has that keyword.",
  Direct:
    "During the Issue Orders step of the Command Phase, a unit \
with the Direct keyword may issue an Order to an allied unit \
within 2 that has the unit name or unit type specified.",
  Disciplined:
    "After a unit with the Disciplined X keyword is issued an Order, \
it may remove up to X Suppression tokens.",
  Disengage:
    "A Trooper unit with the Disengage keyword can make Moves as \
normal while it is Engaged with a single enemy unit.",
  Distract:
    "As a Free Card action, a unit with the Distract keyword can \
...
results.",
  "Djem So Mastery":
    "When a unit with the Djem So Mastery keyword defends \
...
more Blank results.",
  "Droid Trooper":
    "Droid troopers cannot be suppressed, but they can still become panicked. Cannot gain or receive poison tokens.",
  Duelist:
    "When a unit with the Duelist keyword makes a Melee attack, if \
...
greater than or equal to X again.",
  Entourage:
    "During Army Building, for each unit a player includes with \
...
with the Entourage keyword.",
  Equip:
    "During Army Building, if a player includes a unit with the \
Equip keyword, that unit must equip the upgrades listed after \
the keyword.",
  Exemplar:
    "While attacking or defending, if an allied unit is within 2 \
...
checking for Panic.",
  "Fire Support":
    "After a unit with the Fire Support keyword is issued an Order, it \
gains a Standby token.",
  "Flexible Response":
    "During Army Building, a unit with the Flexible Response \
keyword must equip X HEAVY WEAPON upgrades.",
  "Full Pivot":
    "When a unit with the Full Pivot keyword makes a Pivot, it may \
Pivot up to 360°.",
  Generator:
    "During the End Phase, a unit with the Generator X keyword \
may flip up to X inactive Shield tokens to their active side",

  Guardian:
    "While an allied Trooper unit within 1 and in LOS of a unit \
...
such terrain.",
  Strafe:
    "If a unit with the Hover: Ground/Air X keyword has a base with \
...
a minimum of 1.",
  Hunted:
    "During Setup, if 1 or more enemy units have the Bounty \
keyword, each unit with the Hunted keyword gains 1 \
Bounty token.",
  "I'm Part of the Squad Too":
    "A unit with the I'm Part of the Squad Too keyword is \
...
Guardian X keyword.",
  "Immune: Range 1 Weapons":
    "An Attack Pool that is assigned to a unit with the Immune: 1 \
...
the Incognito keyword for the remainder of the game.",
  ...
  Inconspicuous:
    "While a unit with the Inconspicuous keyword has 1 or more \
...
tokens, including 0.",
  Independent:
    "At the start of the Activation Phase, if a unit with the \
...
overlap impassable terrain when they are placed using Infiltrate.",
  Inspire:
    "When a unit with the Inspire X keyword ends its Activation, \
...
priority, treat that Command Card as having 1 more pip.",
  "Jar'Kai Mastery":
    "When a unit with the Jar'Kai Mastery keyword makes a Melee \
...
tokens to change a Blank result to a CRIT result.",
  "Jedi Hunter":
    "When a unit with the Jedi Hunter keyword attacks a unit with \
...
position.",
  "Juyo Mastery":
    "While a unit with the Juyo Mastery keyword has 1 or more \
...
actions during its Activation, including free actions.",
  "Latent Power":
    "When a unit with the Latent Power keyword ends its Activation, \
...
within 1 of this miniature.",
  "Low Profile":
    "When a unit with the Low Profile keyword would roll 1 or more \
...
Cover Pool after rolling.",
  "Makashi Mastery":
    "When a unit with the Makashi Mastery keyword makes a Melee \
...
sequence, after the attack is resolved, it gains 1 Dodge token.",
  Observe:
    "As a Card action, a unit with the Observe X keyword can \
...
Observation tokens in any order.",
  "One Step Ahead":
    "If 1 or more allied units have the One Step Ahead keyword, \
...
during its Activation.",
  Precise:
    "Each time a unit with the Precise X keyword spends an Aim \
token during the Reroll Attack Dice step, it can reroll up to X \
additional attack dice per Aim token spent.",
  "Prepared Position":
    "During the Deploy in Prepared Positions step of Setup, a unit \
...
terrain when they are placed using Prepared Position.",
  Programmed:
    "A unit with the Programmed keyword must equip at least 1 PROTOCOL \
Upgrade Card during Army Building.",
  "Pulling the Strings":
    "As a Card action, a unit with the Pulling the Strings keyword \
may choose another allied Trooper unit within 2. The chosen \
unit may make a free Attack action or a free Move action.",
  "Quick Thinking":
    "When a unit makes the Quick Thinking Card action, it gains 1 \
Aim and 1 Dodge token.",
  Ready:
    "After a unit with the Ready X keyword makes a Standby action, \
it gains X Aim tokens.",
  Recharge:
    "When a unit with the Recharge X keyword makes a Recover \
action, it may flip up to X inactive Shield tokens from their \
inactive side to their active side.",
  Reinforcements:
    "At the start of the End Phase of the first Round, a Unit with the \
Reinforcements keyword may make a Speed-1 Move.",

  Regenerate:
    "When a unit with the Regenerate X keyword ends its Activation, \
it rolls 1 white defense die for each Wound token it has, up to X. \
For each BLOCK or SURGE result, it removes 1 Wound token.",
  Reliable:
    "A unit with the Reliable X keyword gains X surge tokens at the \
start of each Activation Phase.",
  Relentless:
    "After a unit that has the Relentless keyword makes a Move \
action during its Activation, it may make a free Attack action.",
  Reposition:
    "When a unit with the Reposition keyword makes a Standard \
Move, it may make a Pivot either before or after making that \
Standard Move.",
  Retinue:
    "At the start of each Activation Phase, if a unit with the Retinue \
...
Scouting Party keyword.",
  "Secret Mission":
    "At the beginning of each Command Phase, if a unit with the \
...
for each Secret Mission token removed in this way.",
  "Self-Destruct":
    "A unit may make a Self-Destruct X Card action only if it has \
...
rolled. After all rolls are resolved, this unit is defeated.",
  "Self-Preservation":
    "A unit with the Self-Preservation keyword cannot use the COURAGE \
...
critical CRIT result for each Shield token flipped in this way.",
  "Shien Mastery":
    "When a unit with the Shien Mastery keyword uses the Deflect \
...
Assign Suppression Token to Defender step of that attack.",
  Smoke:
    "A unit that has the Smoke X keyword can make the Smoke X \
...
cannot be rerolled more than once using Soresu Mastery.",
  Speeder:
    "A unit with the Speeder X keyword can Move over or end \
...
Tool as possible.",
  Spotter:
    "As a Card or Free Card action, a unit with the Spotter X \
...
Prepared Positions step of Setup.",
  Steady:
    "After a unit that has the Steady keyword makes a Move action \
...
Dodge tokens, the other unit gains 1 token of the same type.",
  Target:
    "After a unit with the Target X keyword is issued an Order, it \
gains X Aim tokens.",
  Tempted:
    "If an allied unit is defeated by an enemy attack and the attacking \
...
or Restored.",
  Unhindered:
    "When a unit that has the Unhindered keyword makes a Move, \
...
or Advantage token as the attacking unit leader.",
  "Weighed Down":
    "A unit with the Weighed Down keyword cannot use the Jump \
keyword while it is holding 1 or more Objective tokens.",
  "We're Not Regs":
    "A unit with the We're Not Regs keyword cannot spend Green \
...
the same attack.",
  Blast:
    "A defending unit cannot use light or heavy Cover during the \
...
arc of the attacking miniature.",
  "High Velocity":
    "A unit that defends against an attack that only has weapons with \
High Velocity in its Attack Pool cannot spend Dodge tokens \
during the Apply Dodge and Cover step.",
  Immobilize:
    "A unit that suffers 1 or more Wounds from an attack that has \
...
only 2 of its original Pierce 3 have been used so far.",
  Poison:
    "A non-Droid Trooper Trooper unit that suffers 1 or more \
...
Ram X.",
  Scatter:
    "When a unit attacks a small based Trooper unit with an Attack \
...
Melee attack.",
  ...
  // Upgrades/CCs
  "Bane Tokens":
    "Cad Bane has a set of 3 unique Bane tokens that he can place \
...
revealed, it has 1 of the following effects (Here I Am, Smoke and Mirrors, Kablamo!):",
  "Here I Am":
    "If Cad Bane is not on the battlefield and is not \
...
player may reveal an allied Here I Am token and resolve it.",
  ...
  "Kablamo!":
    "The token detonates using the weapon profile on \
...
Leader keyword.",
  Noncombatant:
    "A miniature with the Noncombatant keyword cannot add \
...
they are in play.",
  Reconfigure:
    "When a unit equipped with an Upgrade Card that has the \
...
identical actions from different sources.",
  Restore:
    "Some abilities, such as the Treat and Repair keywords or certain \
...
Ranged keyword.",
  ...
  Small:
    "A unit that has 1 or more Counterpart miniatures with the \
...
Small keyword",
  Treat:
    "When a unit uses the Treat X: Capacity Y Card or Free Card \
