...
If a unit cannot perform any of its listed actions as its ?rst \
action, it is free to perform other actions as normal."
	},
	"Aid":{
		"summary":"",
		"full":"When a unit with the Aid keyword would gain an aim, \
dodge, or surge token, another friendly unit of the a?liation \
...
orders to friendly Mercenary units regardless of a?liation. \
...
that rank if a unit with the speci?ed unit name is included in \
the same army."
	},
	"Ataru Mastery":{
		"summary":"",
...
token is removed."
	...
	"Here I Am":{
		"summary":"",
		"full":"If Cad Bane is not on the battle?eld and is not \
...
battle?eld within contested territory. \
...
unit name or unit type speci?ed. A unit that has one or more \
...
gains X dodge tokens."
	...
	"Deflect":{
		"summary":"",
		"full":"While a unit with the De?ect keyword is defending against \
...
defense roll. \
If the De?ect keyword causes the attacking unit to be defeated, \
...
keyword are the only weapons in an attack pool, the De?ect \
...
Detachment: Shoretroopers keyword, the player must ?rst add \
...
to their army, and therefore must ?rst select a second unit of \
...
speci?ed type. If a token would detonate, that token detonates \
...
token. After a token detonates, remove it from the battle?eld."
	},
	"Direct":{
		"summary":"",
...
that has the unit name or unit type speci?ed."
	},
	"Disciplined":{
		"summary":"",
...
dice pools if, after ?rst forming a dice pool with eligible weapons, \
there are still weapons usable by miniatures in the unit that were \
not eligible to be added to the ?rst attack pool. \
...
Command Card ?rst. If this opportunity is declined, that card \
...
keyword and that share the same faction or a?liation as that \
...
priority must decide ?rst whether to play a Flaw Card or not. \
If neither player has priority, then the blue player decides ?rst. \
...
may ?ip up to X inactive shield tokens to their active side."
	},
	"Graffiti Token":{
		"summary":"",
...
Gra?ti tokens remain in play until the end of the game. Units may \
move through and end a movement overlapping gra?ti tokens."
	},
	"Guardian":{
		"summary":"",
...
bene?t from backup and ignores the m rank requirement to \
provide backup."
	},
	"Guidance":{
		"summary":"",
		"full":"When a unit uses the Guidance card action, choose another \
friendly unit of the speci?ed unit type at 2. The chosen unit \
...
Immune: De?ect keyword, the attacking unit cannot suffer \
wounds from the De?ect keyword."
	},
	"Immune: Blast":{
		"summary":"",
...
when they are placed using In?ltrate."
	},
	"Inspire":{
		"summary":"",
...
effects of di?cult terrain and other miniatures with a height \
...
keyword also bene?ts from the Loadout ability."
	},
	"Long Shot":{
		"summary":"",
...
Pro?le keyword would roll one or more defense dice during the \
...
Recon?gure keyword recovers or performs a recover action, the \
player that controls that unit may ?ip that Upgrade Card to a \
different side in addition to any other effects of that recover. \
If an Upgrade Card has the exhaust icon, using the Recon?gure \
...
that miniature on the battle?eld in cohesion with its unit leader. \
...
or other smoke tokens and must be placed on a ?at surface."
},
	"Smoke Tokens":{
...
an army using the speci?ed Battle Force."
	},
	"Speeder":{
		"summary":"",
...
For example, if an AT-RT with a ?amethrower attacks a unit of \
3 Death Troopers, since the ?amethrower has the Spray keyword \
and an attack value of 2 black die, the ?amethrower contributes \
...
unit that has the unit name speci?ed by the Teamwork keyword, \
...
di?cult terrain. A unit may use the Tempted keyword only once \
each round."
	},
	"Tow Cable":{
		"summary":"",
...
and each die cannot be rerolled more than once."
	...
	"Unconcerned":{
		"summary":"",
		"full":"A unit with the Unconcerned keyword cannot bene?t from \
...
into, or through di?cult terrain."
	},
	"Unstoppable":{
		"summary":"",
...
Cover 2 keyword and cannot attack or ?ip active shield tokens. \
...
the unit with a Wheel Mode token."
	...
	"Wound":{
		"summary":"",
		"full":"The ?rst time a unit with the Wound X keyword enters play, \
