...
import AddCounterpartButton from '../../ListUnits/AddCounterpartButton';
import AddUpgradeButton from '../../ListUnits/AddUpgradeButton';
import UpgradeChip from '../../ListUnits/UpgradeChip';
import ListContext from 'context/ListContext';
import UnitContext from 'context/UnitContext';

function DossierUpgrades({
  counterpartId,
  ...
  const {setCardPaneFilter, handleCardZoom, currentList, registerList} = useContext(ListContext);
  ...
  console.log('dossier ups', JSON.stringify(unit.upgradesEquipped));
  // register edit; shows all upgrades, lets unlimited amt added
  if(!isBattle){
  ...
  // else just normal listbuild display - todo to get this refactored to reuse the old one
  else{
  unit.upgradesEquipped.forEach((upgradeId, upgradeIndex) => {
    const upgradeType = totalUpgradeBar[upgradeIndex];
...
export default DossierUpgrades;